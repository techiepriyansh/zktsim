...
mod tests {
    ...
    use crate::gadgets::poseidon::primitives::{
    ...
    fn permute_test_vectors() {
        {
            ...
            for tv in crate::gadgets::poseidon::primitives::test_vectors::fp::permute() {
                let mut state = [
...

        {
            ...
            for tv in crate::gadgets::poseidon::primitives::test_vectors::fq::permute() {
                let mut state = [
...

        {
            ...
            for tv in crate::gadgets::poseidon::primitives::test_vectors::fr::permute() {
                let mut state = [
    ...
    fn hash_test_vectors() {
        ...
        for tv in crate::gadgets::poseidon::primitives::test_vectors::fq::hash() {
            let message = [
        ...
        for tv in crate::gadgets::poseidon::primitives::test_vectors::fr::hash() {
            let message = [
